...
public class UserController {
	...
	public void getPhoneCode(HttpServletResponse response, HttpSession session, @RequestParam("phone") String phone)
			throws IOException {
	...
	public void checkPhoneCode(String phone, HttpServletResponse response, String phoneCode, HttpSession session)
			throws IOException {
	...
	public void phoneIsExit(HttpSession session, HttpServletResponse response, @RequestParam("phone") String phone)
			throws IOException {
	...
	public void checkImgCode(HttpServletRequest request, HttpServletResponse response) throws Exception {
	...
	public String updatePasswordByPhone(@RequestParam("newPassword") String password, HttpSession session) {
		// 获取当前通过手机号查到的对象id
		User user = (User) session.getAttribute("loginSession");
		//session.setAttribute("userSession", user);
		session.removeAttribute("loginSession");		
	...
	public void checkOldPassword(@RequestParam("oldPassword") String oldPassword, HttpServletResponse response,
	...
	public void checkIsLogin(HttpServletResponse response, HttpSession session) throws Exception {

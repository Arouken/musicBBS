...
<body>
	<div>
		<form class="layui-form" action="" method="post"
			enctype="multipart/form-data" lay-filter="user-edit">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="radio" name="class" value="0" title="用户" checked="">
					<input type="radio" name="class" value="1" title="管理员">
	...
	<script
		src="${pageContext.request.contextPath}/layui-v2.6.1/layui/layui.js"></script>
									...
									.render({
										...
										url : '${pageContext.request.contextPath}/user/uploadPhoto',
											...
											if (res.code == 0) {
												$('.upload-img')
														.html(
																'<img class="layui-upload-img" style="width:80px;height:100px" src="'+res.src+'" id="demo1"> <p id="demoText"></p>');
												$('.layui-btn-img').css({
													"margin-left" : "104px",
													"width" : "90px",
													"margin-top" : "6px"
